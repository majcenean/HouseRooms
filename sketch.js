...
// //   Draw the debug red y-lines (works but commented out because it is unnecessary)
//     for (let i = quady2; i <= quady3 + 2; i += (quady3-quady2)/9) {
//       push();
//       stroke('red');
//       line(quadx3, i, quadx4, i);
//       pop();
//       measureNumberY = measureNumberY + 3;
//     }
...
// //   circle points
//   fill('#9CC797');
//   ellipse(upperQuadXCoords[8], quady2, 10);
//   ellipse(upperQuadXCoords[10], quady2, 10);
//   ellipse(upperQuadXCoords[8] + upperQuadXCoords[8]/60, quadYCoords[4], 10);
//   ellipse(upperQuadXCoords[10] + upperQuadXCoords[10]/40, quadYCoords[4], 10);
...
function drawMainSprite() {
 ...
 if (mainsprite.position.x < quadx3-50 + mainspriteW/2)
  ...
  if (mainsprite.position.y < quady2-boxH + mainspriteH/2)
    mainsprite.position.y = quady2-boxH + mainspriteH/2;
...
function drawStamina() {
  ...
  noStroke();
  fill(200);
 rect(mainsprite.position.x - mainspriteW/2.5, mainsprite.position.y - mainspriteH/2 + 20, 210, 20);
  fill('lightgreen');
  rect(mainsprite.position.x + 5 - mainspriteW/2.5, mainsprite.position.y + 5 - mainspriteH/2 + 20, stamina, 10);
  pop();
}
